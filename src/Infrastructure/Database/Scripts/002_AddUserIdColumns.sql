...
DECLARE @OwnerEmail NVARCHAR(256) = N'SEU_EMAIL_AQUI@exemplo.com'; -- <<< EDITE AQUI
...
BEGIN
    ...
    UPDATE dbo.CARTEIRA SET UserId = @OwnerUserId WHERE UserId IS NULL;
...
BEGIN
    ...
    UPDATE dbo.CONTA SET UserId = @OwnerUserId WHERE UserId IS NULL;
...
BEGIN
    ...
    UPDATE dbo.CATEGORIA SET UserId = @OwnerUserId WHERE UserId IS NULL;
...
BEGIN
    ...
    UPDATE dbo.CONTA_PAGAR SET UserId = @OwnerUserId WHERE UserId IS NULL;
...
BEGIN
    ...
    UPDATE dbo.CONTA_PAGAR_CADASTRO SET UserId = @OwnerUserId WHERE UserId IS NULL;
...
BEGIN
    ...
    UPDATE dbo.CONTA_RECEBER SET UserId = @OwnerUserId WHERE UserId IS NULL;
...
BEGIN
    ...
    UPDATE dbo.CONTA_RECEBER_CADASTRO SET UserId = @OwnerUserId WHERE UserId IS NULL;
...
BEGIN
    ...
    UPDATE dbo.FinanciamentoImobiliarioRuaPascoalDias263 SET UserId = @OwnerUserId WHERE UserId IS NULL;
