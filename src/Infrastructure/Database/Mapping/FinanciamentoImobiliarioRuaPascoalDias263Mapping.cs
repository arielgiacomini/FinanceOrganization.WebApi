...
namespace Infrastructure.Database.Mapping
{
    public class FinanciamentoImobiliarioRuaPascoalDias263Mapping : IEntityTypeConfiguration<FinanciamentoImobiliarioRuaPascoalDias263>
    {
        ...
        {
            builder.ToTable("FinanciamentoImobiliarioRuaPascoalDias263");
            ...
            builder.Property(x => x.EffectiveAnnualRateAA).HasColumnName("TaxaEfetiva");
            ...
            builder.Property(x => x.SafeDFI).HasColumnName("SeguroDIF");
            ...
            builder.Property(x => x.MonthlyFGTS).HasColumnName("FGTSMesal");
